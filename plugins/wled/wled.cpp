...
void wled::entity_registry_enabled_default()
{
}


void wled::should_poll()
{
}


void wled::device_state_attributes()
{
}
...
void wled::_schedule_immediate_update()
{
}

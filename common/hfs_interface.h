...
public:
    ...
    virtual void subscribe(QObject *obj, QString pah, QString funcname=QString("setElementProperty"), int mode=SingleInterest) = 0;
    virtual void unsubscribe(QObject *obj, QString path, QString funcname=QString("setElementProperty")) = 0;
    virtual QString provides(QObject *obj, QString path, int platform, QString keyidx) = 0;

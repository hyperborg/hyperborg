...
class LightEntity : public Entity
{
    ...
    Q_PROPERTY(QString xyColor MEMBER _xcColor);			 // Return the xy color value (float, float). This property will be copied to the light's state attribute when the light's color mode is set to ColorMode.XY and ignored otherwise.
